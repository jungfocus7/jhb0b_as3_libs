package hbx.utils
{
	...
	{
		//:: Text Cutting
		public static function cutting_last(ttf:TextField, str:String, gan:Number, takeStr:String = null):void
		{
			if (takeStr == null)
				takeStr = '...';
		...
		//::
		public static function append_text(cont:DisplayObjectContainer, tfn:String, v:String, bnl:Boolean = false, bes:Boolean = false):void
		{
			var t_tf:TextField = cont[tfn];
			if (t_tf == null) return;
