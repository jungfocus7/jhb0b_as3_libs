package hbx.utils
{
	...
	public final class MMovieClipUtil
	{
		...
		//:: 무비클립 기본 롤오버아웃 등록하기
		public static function add_roo(tmc:MovieClip, isButtonMode:Boolean = true):void
		{
		...
		//:: 무비클립 클릭 핸들러 등록
		public static function add_clickHandler(tmc:MovieClip, clickHandler:Function, isButtonMode:Boolean = true):void
		{
			tmc.mouseChildren = false;
			tmc.buttonMode = isButtonMode;
		...
		//:: 무비클립 클릭 핸들러 등록 roo
		public static function add_clickHandler_roo(tmc:MovieClip, clickHandler:Function, isButtonMode:Boolean = true):void
		{
		...
		//:: 특정 프래임이후에 함수 호출
		public static function delayExcute(tmc:MovieClip, afterCall:Function, afterCallParams:Array = null, countLen:uint = 1):void
		{
