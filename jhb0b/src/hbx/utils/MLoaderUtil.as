package hbx.utils
{
	...
	public final class MLoaderUtil
	{
		...
		//:: 로더 생성후 로드
		public static function createAndLoad(container:DisplayObjectContainer, url:String, loaderContext:LoaderContext = null,
			completeHandler:Function = null, progressHandler:Function = null, ioErrorHandler:Function = null):Loader
		{
		...
		//:: 로드
		public static function load(loader:Loader, url:String,
			loaderContext:LoaderContext = null, isUnload:Boolean = true):void
		{
			if (isUnload)
			{
				try
