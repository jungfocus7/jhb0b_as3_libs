package hbx.utils
{
	...
	public final class MURLLoaderUtil
	{
		...
		//:: URLLoader 생성
		public static function create(completeHandler:Function = null, progressHandler:Function = null, ioErrorHandler:Function = null):URLLoader
		{
		...
		//::
		public static function createAndLoad_a(ur:URLRequest,
			completeHandler:Function = null, progressHandler:Function = null, ioErrorHandler:Function = null):URLLoader
		{
			var t_ul:URLLoader = create(completeHandler, progressHandler, ioErrorHandler);
			t_ul.load(ur);
