package hbx.media
{
	...
	import hbx.core.CDisplayObjectContainerWrapper;
	import hbx.core.CEventCore;
	import hbx.found.CBumButton;
	import hbx.found.CBumSliderFrame;



	public class CBumAbstractPlayer extends CDisplayObjectContainerWrapper
	{
							...
							tInstNameArr:Array = null, tbsfNumArr:Array = null, tbbComFrameArr:Array = null, tEtcValArr:Array = null)
		{
			...
			_View = _container[tInstNameArr[0]];
			_View.mouseChildren = false;
			_View.mouseEnabled = false;
			_Controller = _container[tInstNameArr[1]];
		...
		protected function pp_bbPlayPause_click(tevt:CEventCore):void
		{
		}


		protected var _bbStop:CBumButton;
		protected function pp_bbStop_click(tevt:CEventCore):void
		{
		}
		...
		protected function pp_bsfSeek_update(tevt:CEventCore):void
		{
		}
		protected function pp_bsfSeek_mouseUp(tevt:CEventCore):void
		{
		}
		protected function pp_bsfSeek_mouseDown(tevt:CEventCore):void
		{
		}
		...
		protected function pp_bbMute_click(tevt:CEventCore):void
		{
		}


		protected var _bsfVolume:CBumSliderFrame;
		protected function pp_bsfVolume_update(tevt:CEventCore):void
		{
		}
