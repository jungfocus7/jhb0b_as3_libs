package hbx.media
{
	...
	import hbx.media.CBumAbstractPlayer;
	import hbx.prepared.MDateHelper;
	...
	public class CBumVideoPlayer extends CBumAbstractPlayer
	{
		...
		protected function ppVideoStreamStreamError(tevt:CEventCore):void
		{
			//p_test(tevt.type);
		}
		protected function ppVideoStreamLoadProgress(tevt:CEventCore):void
		{
			//p_test(tevt.type);
		}
		protected function ppVideoStreamLoadComplete(tevt:CEventCore):void
		{
			//p_test(tevt.type);
		}
		protected function ppVideoStreamPlayReady(tevt:CEventCore):void
		{
			//p_test(tevt.type);
		...
		protected function ppVideoStreamPlayStop(tevt:CEventCore):void
		{
			//p_test(tevt.type);
			pp_bbStop_click(null);
		}
		protected function ppVideoStreamPositionUpdate(tevt:CEventCore):void
		{
			//p_test(tevt.type);
		...
		override protected function pp_bbPlayPause_click(tevt:CEventCore):void
		{
		...
		override protected function pp_bbStop_click(tevt:CEventCore):void
		{
			if (this.getIsEmptyVideoStream()) return;
		...
		override protected function pp_bsfSeek_update(tevt:CEventCore):void
		{
			if (this.getIsEmptyVideoStream()) return;
		...
		override protected function pp_bsfSeek_mouseUp(tevt:CEventCore):void
		{
			if (this.getIsEmptyVideoStream()) return;
		...
		override protected function pp_bsfSeek_mouseDown(tevt:CEventCore):void
		{
			if (this.getIsEmptyVideoStream()) return;
		...
		override protected function pp_tfTime_update(tIsReset:Boolean):void
		{
			...
			var tNowPos:Number = _VideoStream.getPosition();
			var tEndPos:Number = _VideoStream.getDuration();
			var tNowTime:String = MDateHelper.formatCode(tNowPos);
			var tEndTime:String = MDateHelper.formatCode(tEndPos);
			if (tIsReset)
		...
		override protected function pp_bbMute_click(tevt:CEventCore):void
		{
			if (this.getIsEmptyVideoStream()) return;
		...
		override protected function pp_bsfVolume_update(tevt:CEventCore):void
		{
			if (this.getIsEmptyVideoStream()) return;
